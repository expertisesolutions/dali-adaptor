...
void WindowBaseCocoa::SetType( Dali::Window::Type type )
{
}

bool WindowBaseCocoa::SetNotificationLevel( Dali::Window::NotificationLevel::Type level )
{
  return false;
}

Dali::Window::NotificationLevel::Type WindowBaseCocoa::GetNotificationLevel() const
{
...
bool WindowBaseCocoa::SetScreenOffMode(Dali::Window::ScreenOffMode::Type screenOffMode)
{
  return false;
}

Dali::Window::ScreenOffMode::Type WindowBaseCocoa::GetScreenOffMode() const
{
